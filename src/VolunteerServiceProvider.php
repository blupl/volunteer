<?php namespace Blupl\Volunteer;

use Orchestra\Volunteer\Providers\ServiceProvider;
...
//        $this->app->bind('Orchestra\Control\Contracts\Command\Synchronizer', 'Orchestra\Control\Command\Synchronizer');
    ...
    public function boot()
    {
        ...
        $this->addConfigComponent('blupl/volunteer', 'blupl/volunteer', $path.'/resources/config');
        $this->addLanguageComponent('blupl/volunteer', 'blupl/volunteer', $path.'/resources/lang');
        $this->addViewComponent('blupl/volunteer', 'blupl/volunteer', $path.'/resources/views');
...
//    }
    ...
    {
        $this->app['events']->listen('orchestra.ready: admin', 'Blupl\Volunteer\Http\Handlers\VolunteerMenuHandler');
    }
...
//    }
    ...
    {
        $this->app['orchestra.extension.config']->map('blupl/Volunteer', [
